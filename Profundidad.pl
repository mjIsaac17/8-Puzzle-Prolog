...
/*Jueves 11 de Noviembre 2018*/
/*Método de búsqueda por profundidad 8 puzzle*/
...
profundidad([],_,[]).
profundidad(Tmeta,Tmeta,Tmeta):-write(inicio),nl,printTab(Tmeta),nl.
profundidad(Tin,Tmeta,Recorrido):-write(inicio),nl,printTab(Tin),profundidadR(Tin,Tmeta,Recorrido).
profundidadR(Tmeta,Tmeta,Tmeta).
profundidadR(Tin,Tmeta,[Tab|Recorrido]):-izq(Tin,Tab),Tab\=[],write(izquierda),nl,printTab(Tab),profundidadR(Tab,Tmeta,Recorrido).
profundidadR(Tin,Tmeta,[Tab|Recorrido]):-arr(Tin,Tab),Tab\=[],write(arriba),nl,printTab(Tab),profundidadR(Tab,Tmeta,Recorrido).
profundidadR(Tin,Tmeta,[Tab|Recorrido]):-der(Tin,Tab),Tab\=[],write(derecha),nl,printTab(Tab),profundidadR(Tab,Tmeta,Recorrido).
profundidadR(Tin,Tmeta,[Tab|Recorrido]):-aba(Tin,Tab),Tab\=[],write(abajo),nl,printTab(Tab),profundidadR(Tab,Tmeta,Recorrido).
